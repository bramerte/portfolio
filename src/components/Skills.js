...
export const Skills = () => {
  const skills = [
    ...
    { title: "VS Code", level: 90, category: "Tools" },
    ...
    { title: "Java", level: 85, category: "Languages" },
    ...
    { title: "Git Bash", level: 85, category: "Tools" },
    { title: "Visual Studio", level: 85, category: "Tools" },
    { title: "React", level: 85, category: "Frameworks" },
    { title: "Software Design", level: 85, category: "Proficiencies" },
    { title: "Algorithms", level: 85, category: "Proficiencies" },
    { title: "JavaScript", level: 85, category: "Languages" },
    { title: "TypeScript", level: 80, category: "Languages" },
    { title: "C++", level: 80, category: "Languages" },
    { title: "C#", level: 80, category: "Languages" },
    { title: "XML", level: 80, category: "Languages" },
    ...
    { title: "Machine Learning", level: 80, category: "Proficiencies" },
    { title: "C", level: 75, category: "Languages" },
    { title: "Unity", level: 75, category: "Languages" },
    { title: "GraphQL", level: 75, category: "Languages" },
    { title: "Prisma", level: 75, category: "Frameworks" },
    { title: "Apache Spark", level: 75, category: "Frameworks" },
    { title: "Apache Kafka", level: 75, category: "Frameworks" },
    ...
    { title: "Computer Vision", level: 75, category: "Proficiencies" },
    { title: "Solidity", level: 70, category: "Languages" },
    { title: "Bash", level: 70, category: "Languages" },
    { title: "Angular", level: 70, category: "Frameworks" },
    { title: "MediaPipe", level: 70, category: "Libraries" },
    { title: "Blockchain Technology", level: 70, category: "Proficiencies" },
    { title: "Assembly Language", level: 65, category: "Languages" },
  ];
